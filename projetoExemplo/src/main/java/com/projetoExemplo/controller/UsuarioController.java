...
public class UsuarioController {
	...
	@PutMapping("/{id}")
	@Operation(summary = "Altera um usuários")
	public ResponseEntity<Usuario> alteraUsuarioControlId(@PathVariable Long id,@RequestBody @Valid Usuario usuario ){
	...
	@DeleteMapping("/{id}")
	@Operation(summary = "Exclui um usuários")
